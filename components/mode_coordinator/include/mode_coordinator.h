...
// ═══════════════════════════════════════════════════════════════════════════════
// CORE TYPE DEFINITIONS - MOVED TO TOP
// ═══════════════════════════════════════════════════════════════════════════════
...
/**
 * @brief Wire learning results - FORWARD DECLARATION ONLY
 * Full definition is in wire_learning_mode.h
 */
struct wire_learning_results_t;
...
typedef struct {
    ...
    // Mode-specific data - SIMPLIFIED
    bool wire_learning_complete;
    float wire_length_m;
 ...
 * @return ESP_OK on success
 */
esp_err_t mode_coordinator_set_wire_learning_results(const struct wire_learning_results_t* results);

/**
 * @brief Get wire learning results
 * @return Pointer to wire learning results, NULL if not available
 */
const struct wire_learning_results_t* mode_coordinator_get_wire_learning_results(void);
...
// ═══════════════════════════════════════════════════════════════════════════════
// UTILITY FUNCTIONS - FIXED DECLARATIONS
// ═══════════════════════════════════════════════════════════════════════════════
